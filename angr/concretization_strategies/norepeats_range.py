...
class SimConcretizationStrategyNorepeatsRange(SimConcretizationStrategy):
    ...
    def __init__(self, repeat_expr, min=None, granularity=None, **kwargs):  # pylint:disable=redefined-builtin  # noqa: A002
    ...
    def merge(self, others):
        ...
        self._repeat_min = max(self._repeat_min, *(o._repeat_min for o in others))
        self._repeat_granularity = max(self._repeat_granularity, *(o._repeat_granularity for o in others))
