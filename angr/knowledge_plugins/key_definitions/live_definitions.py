...
class LiveDefinitions:
    ...
    def __init__(
        ...
        canonical_size=8,
        registers: MultiValuedMemory | None = None,
        stack: MultiValuedMemory | None = None,
        memory: MultiValuedMemory | None = None,
        heap: MultiValuedMemory | None = None,
        tmps: dict[int, set[Definition]] | None = None,
        others: dict[Atom, MultiValues] | None = None,
        register_uses: Uses | None = None,
        stack_uses: Uses | None = None,
        heap_uses: Uses | None = None,
        memory_uses: Uses | None = None,
        tmp_uses: dict[int, set[CodeLocation]] | None = None,
        other_uses: Uses | None = None,
        element_limit=5,
