...
class Fuzzer:
    def __init__(
        ...
        :param engine: The engine used to execute each input, either an engine or a callable
            building one from the project. It is built once, reused across executions, and
